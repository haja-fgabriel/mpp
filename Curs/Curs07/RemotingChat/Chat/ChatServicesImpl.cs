...
namespace Chat
{
    public class ChatServicesImpl : MarshalByRefObject, IChatServices
    {
        private UserRepository userRepository;
        private readonly IDictionary<String, IChatObserver> loggedClients;
        public ChatServicesImpl(UserRepository repo)
        {
        ...
        public void sendMessage(Message message)
        {
            ...
            if (loggedClients.ContainsKey(id_receiver))
            {     //the receiver is logged in
        ...
        public User[] getLoggedFriends(User user)
        {
            ...
            {
                if (loggedClients.ContainsKey(friend.Id))
